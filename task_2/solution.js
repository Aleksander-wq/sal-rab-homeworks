function calcShipping(sum, min, shipping) {
    ...
    if (productSum == 0 ) {  (shippingPrice = 0);
    }
    if (productSum >= freeShippingMinSum) {  (shippingPrice = 0);
    }
...
function calcDiscount(sum, min, discount) {
    ...
    if (productsSum >= discountMinSum) {  (discountPrice = (discountPart*productsSum/100));
